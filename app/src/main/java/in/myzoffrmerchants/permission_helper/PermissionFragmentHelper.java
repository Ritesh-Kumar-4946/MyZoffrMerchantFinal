package in.myzoffrmerchants.permission_helper;
...
import in.myzoffrmerchants.permission_callback.OnActivityPermissionCallback;
...
public class PermissionFragmentHelper implements OnActivityPermissionCallback {
     ...
     */
    @NonNull
    public PermissionFragmentHelper setForceAccepting(boolean forceAccepting) {
