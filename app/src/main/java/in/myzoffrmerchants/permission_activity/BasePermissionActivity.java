package in.myzoffrmerchants.permission_activity;
...
import in.myzoffrmerchants.permission_adapter.PermissionPagerAdapter;
import in.myzoffrmerchants.permission_callback.BaseCallback;
import in.myzoffrmerchants.permission_callback.OnPermissionCallback;
import in.myzoffrmerchants.permission_fragment.PermissionFragment;
import in.myzoffrmerchants.permission_helper.PermissionHelper;
import in.myzoffrmerchants.permission_model.PermissionModel;
import in.myzoffrmerchants.permission_utils.FontTypeHelper;
import in.myzoffrmerchants.permission_utils.ThemeUtil;
import in.myzoffrmerchants.permission_widget.CirclePageIndicator;
...
public abstract class BasePermissionActivity extends AppCompatActivity implements OnPermissionCallback, BaseCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pager.setAdapter(new PermissionPagerAdapter(getSupportFragmentManager(), permissions()));
